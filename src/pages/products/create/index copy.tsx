...
import CategorySelector from '@/features/products/components/ProductCategorySelector';
...
import SellingPriceModal, {
  type PriceFormData,
} from '@/features/products/components/ProductSellingPriceModal';
import VariantPriceTable from '@/features/products/components/ProductVariantPriceTable';
...
const CreateProductPage = () => {
  ...
  const [isOgSameAsMeta, setIsOgSameAsMeta] = useState(false);
